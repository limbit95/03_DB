...
-- EX) 1부터 10가지 1씩 증가하고 반복하는 사퀀스 객체
...
-- [START WITH 숫자] --> 처음 발생시킬 시작 값 지정, 생략하면 자동 1이 기본
-- [INCREMENT BY 숫자] --> 다음 값에 대한 증가치, 생략하면 자동 1이 기본
-- [MAXVALUE 숫자 | NOMAXVALUE] --> 발생시킬 최대값 지정 (10의 27승-1) -> 기본값
-- [MINVALUE 숫자 | NOMINVALUE] --> 발생시킬 최소값 지정 (-10의 26승) -> 기본값
