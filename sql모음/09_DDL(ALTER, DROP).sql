...
-- ORA-12899: "KH_LSH"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
-- DROP TABLE 테이블명 [CASCADE COONSTRAINTS];
...
-- DDL 주의 사항
-- 1) DLL은 COMMIT/ROLLBACK이 되지 않음
--    ALTER, DROP 을 신중하게 진행해야함

-- 2) DDL 과 DML 구문 섞어서 수행하면 안됨
