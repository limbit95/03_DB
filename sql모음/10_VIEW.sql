-- VIEW
-- - SELECT문의 실행 결과(RESULT SET)를 화면 저장하는 객체
--   논리적 가상 테이블
...
-- 3) GRANT CREATE VIEW TO kh_lsh;
-- 4) 권한 부여 받은 kh_lsh 계정으로 겁속하여 위 VIEW 생성 구문 다시 실행

ALTER SESSION SET "_ORACLE_SCRIPT" = TRUE;

GRANT CREATE VIEW TO kh_lsh;
...
-- VIEW의 본래 목적인 보여지는 것(조회)라는 용도에 맞게 사용하는 것이 좋음
